...
export const dict = {
  fa: {
    ...
    hostsPage: {
      ...
      remark: 'نام نمایشی',
      address: 'آدرس',
      port: 'پورت (خالی = از هسته)',
      sniOverride: 'SNI اختصاصی (خالی = از هسته)',
      alpnOverride: 'ALPN اختصاصی (خالی = از هسته)',
    ...
    coresPage: {
      ...
      sniLabel: 'SNI (تارگت)',
      fingerprintLabel: 'فینگرپرینت (Fingerprint)',
      ...
      protocolRequired: 'پروتکل الزامیه',
      networkSecurityRequired: 'شبکه انتقال و امنیت برای این پروتکل الزامیه',
    },
  ...
  en: {
    ...
    hostsPage: {
      ...
      remark: 'Display Name',
      address: 'Address',
      port: 'Port (empty = from Core)',
      sniOverride: 'Custom SNI (empty = from Core)',
      alpnOverride: 'Custom ALPN (empty = from Core)',
    ...
    coresPage: {
      ...
      networkSecurityRequired: 'Transport and security are required for this protocol',
    },
