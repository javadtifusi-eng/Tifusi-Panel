...
export const dict = {
  fa: {
    ...
    coresPage: {
      ...
      ikev2EgressVlessLabel: 'خروجی زنجیره‌ای از VLESS (اختیاری)',
      ikev2EgressVlessHint:
        'خالی بمونه، ترافیک کلاینت‌های IKEv2 مستقیم از خود این نود خارج می‌شه. یه لینک vless:// از یه سرور دیگه بچسبون تا ترافیک IKEv2 از اون سرور رد بشه و IP خروجی همون سرور دیده بشه.',
  ...
  en: {
    ...
    coresPage: {
      ...
      ikev2EgressVlessLabel: 'Chained VLESS egress (optional)',
      ikev2EgressVlessHint:
        "Left blank, IKEv2 client traffic exits directly from this node. Paste a vless:// link to a different server to route IKEv2 traffic through it instead — the exit IP clients see becomes that server's.",
