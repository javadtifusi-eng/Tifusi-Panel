...
// Inline stroke icons for the shell and overview, drawn on a 24px grid in
// the same style as the approved studio preview. No icon library: these are
// the only icons the panel needs.
...
function Svg({ size = 17, strokeWidth = 1.8, className, children }: IconProps & { children: ReactNode }) {
  return (
    <svg
      width={size}
      height={size}
...
export const IconTunnel = (p: IconProps) => (
  <Svg {...p}>
    <path d="M4 17h4l8-10h4" />
    <path d="M17 4l3 3-3 3" />
    <path d="M4 7h4l2 2.5" />
    <path d="M14 14.5 16 17h4" />
