...
5. **تست از ایران** — اندازه‌گیری قطعی سرعت، که با تمام شدن اسکن خودکار شروع می‌شود. فیلترینگ ایران روی اسم‌هایی که نمی‌بندد هم سرعت می‌گذارد، پس هیچ تستی از بیرون ایران نمی‌تواند تارگت‌ها را بر اساس سرعتی که کاربر می‌بیند مرتب کند. نود برای هر تارگت یک inbound موقت REALITY به مدت ۳۰ دقیقه باز می‌کند؛ لینک ساب را روی گوشی با اینترنت ایران وارد کنید، از هر کانفیگ speed test بگیرید، و سرعت واقعی دانلود و آپلود هر تارگت در پنل می‌آید، سریع‌ترین بالا.

مرتب‌سازی در همه‌ی مراحل بر اساس سرعت است: اول کار کردن با chrome و بودن روی شبکه‌ی خود نود، بعد سرعت پاسخ از ایران، بعد هندشیکی که REALITY برای هر اتصال جدید منتظرش است.
