...
from app.routers import admin, api_keys, app_reports, auth, cores, groups, hosts, nodes, reality, settings as settings_router, setup, stats, subscription, system, tunnels, user_templates, users
